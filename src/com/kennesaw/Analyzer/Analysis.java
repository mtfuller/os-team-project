...
public class Analysis {
    ...
    public static void calctoString() {
        ...
        System.out.println(String.format("%5s    | %5s      |%5s  |%9s   |%9s      | %9s       |%9s", "JobID",
                "Wait Times", "    Complete Times", "Number of IO", "CPUID", "CPU Space", " Ram Space Used "));
        for(int i = 0; i < 30; i ++) {
            ...
            System.out.println(String.format("%5s    | %9s ms    | %9s ms       | %9s     | %9s     | %9s       | %9s",
                    jobID1.get(i),
                    real_wait,
                    real_complete,
                    io.get(i),
